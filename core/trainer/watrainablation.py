...
from method.lossablation import wscat_loss
...
class WATrainer(object):
    ...
    def __init__(self, info, args, logger):
        ...
        self.eval_attack = core.metrics.PGD(self.get_model(), eps=8.0/255, alpha=1.0/255, steps=20)
        #self.eval_attack = core.metrics.AutoAttack(self.get_model(), norm='Linf',eps=8.0/255)
        
        self.init_optimizer(self.params.num_adv_epochs)
        self.criterion_contrastive = None
        if args.method == 'wscat' or args.method=='double':
