...
from .cifar10 import load_cifar10,load_cifar10double,load_cifar10triple
from .cifar100 import load_cifar100,load_cifar100double,load_cifar100triple
from .imagenet32 import load_imagenet32,load_imagenet32double,load_imagenet32triple
...
_LOAD_DATASET_FNdouble = {
    'cifar10': load_cifar10double,
    'cifar100': load_cifar100double,
    'imagenet32': load_imagenet32double,
}
_LOAD_DATASET_FNtriple = {
    'cifar10': load_cifar10triple,
    'cifar100': load_cifar100triple,
    'imagenet32': load_imagenet32triple,
}
...
def load_datadouble(data_dir, logger, batch_size=256, batch_size_test=256, num_workers=4, use_augmentation='none', use_consistency=False,
              aux_data_filename=None, unsup_fraction=None, validation=False, take_amount=None, aux_take_amount=None, take_amount_seed=1, add_aux_labels=False,
              pseudo_label_model=None, num_batches=None):

    dataset = os.path.basename(os.path.normpath(data_dir))
    load_dataset_fn = _LOAD_DATASET_FNdouble[dataset]
...
def load_datatriple(data_dir, logger, batch_size=256, batch_size_test=256, num_workers=4, use_augmentation='none', use_consistency=False,
              aux_data_filename=None, unsup_fraction=None, validation=False, take_amount=None, aux_take_amount=None, take_amount_seed=1, add_aux_labels=False,
              pseudo_label_model=None, num_batches=None):

    dataset = os.path.basename(os.path.normpath(data_dir))
    load_dataset_fn = _LOAD_DATASET_FNtriple[dataset]
