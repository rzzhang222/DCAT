    ...
    if lamb > 0:
        ...
        for _ in range(perturb_steps):
            ...
            with torch.enable_grad():
                ...
                if beta > 0:
                    loss_con=(criterion_mi(fea_nat, fea_adv,y=None, mask=mask)+ criterion_mi(fea_nat, fea_adv, y=labels_4_contrast, mask=mask))/2
...
def wscat_lossuseless(criterion_mi, model, x_l, y, x_u, optimizer,
               step_size=0.003, epsilon=0.031, perturb_steps=10, lamb=1.0, beta=1.0,
               contrast_label='auto', attack='linf-pgd', label_smoothing=0.1,
               wamodel=None, consistency_cost=0., consistency_prop_label=0.,
               ):
