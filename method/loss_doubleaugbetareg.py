...
#            labels_4_contrast = pseudo_labels.detach()
    ...
    #since i am doing ablation, comment the line after this
     loss3=loss2+0.1*(criterion_kl(F.log_softmax(logits_adv2,dim=1),F.softmax(logits_adv,dim=1))+beta*criterion_mi(fea_adv2,fea_adv,y=labels_4_contrast, mask=mask))
     loss=loss3
